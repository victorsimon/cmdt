...
class ${className}Controller {
    ...
    def list(Integer max) {
		...
		def list = params.q? ${className}.search(params.q, params).results: ${className}.list(params)
		def total = params.q? ${className}.countHits(params.q): ${className}.count()
        [${propertyName}List: list, ${propertyName}Total: total]
    }
