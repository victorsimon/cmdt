...
<div class="login" style='text-align:center;'>
	...
	<table>
		...
		<tr>
			<td colspan='2'>
				...
				<label for='remember_me'><g:message code='cmdt.login.rememberme' default="Recuerdame"/></label> |
				<span class="forgot-link">
					<g:link controller='register' action='forgotPassword'><g:message code='cmdt.login.forgotPassword' default="Olividé mi clave"/></g:link>
				</span>
			</td>
		</tr>
		<tr>
	...
	<oauth:connect provider="yahoo" id="yahoo-connect-link"><img class="social-login" src="${resource(dir: 'images/social', file: 'y_icon.png')}" alt="Connect with Yahoo" /></oauth:connect>
	</div>
	</div>
	</form>
	</div>
